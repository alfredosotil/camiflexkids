            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="c-content-feature-2" data-wow-delay1="1s" data-height="height">
                        ...
                        <p>Pregunta por nuestro stock de productos.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="c-content-feature-2" data-wow-delay1="1s" data-height="height">
                        ...
                        <p>No debes de preocuparte de nada, nosotros lo hacemos por ti.</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="c-content-feature-2" data-wow-delay1="1s" data-height="height">
                        ...
                        <p>Dejamos tus productos en casa!</p>
                    </div>
                </div>                
                        ...
                        <div class="c-wrapper">
                            <div class="c-body c-padding-20 c-center">  
                                <h3 class="c-font-19 c-line-height-28 c-font-uppercase c-font-white c-font-bold">
                                    Trataremos de dar el mejor servicio posible a nuestros clientes
                                </h3>
                            </div>
                        </div>
                    </div>
